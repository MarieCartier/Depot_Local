...
9- replace (rechercher un caractère ou un expression, et les remplacer par autre chose)
...
/*6*/alert(texte.charAt(5)); // La position 5 correspond à la lettre a, puisque le décompte commence par 0 (J=0), affiche donc la lettre a
...
/*7-8 bis*/alert(texte.indexOf("a", 6)); //cela recherchera le 1er a à partir de la 6eme position, donc le premier a de appelle ne sera pas pris en compte
...
/*11*/ var texte = "            Je m'appelle Marie CARTIER           "; //bcp d'espaces en début et fin à supprimer
